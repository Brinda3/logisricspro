...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <header>
      ...
      <a href="#" class="logo"><img src="logo.jpg" height="50"></a>
    ...
    <section class="home" id="home">
      <div class="content">
       ...
       <font color="orange" size="5"><b>Efficient & Reliable delivery</b></font>
        <p><b>We Provide:-</b></p>
        <ul>
...
if ($result->num_rows > 0) {
  ...
  while($row = $result->fetch_assoc()) {
   # echo "<table><tr><td> " . $row["name"]. " </td><td> " . $row["email"]. "</td><td> " . $row["phone"].    
    #"</td><tr></table>";
   ?>
    <section class="contact" id="contact">
      ...
      <div class="row">
        ...
        >
          ...
          echo "<input type='text' name='name' value='". $row['name']."'placeholder='". $row['name']."' class='box' />
          <input type='email' name='email' value='". $row['email']."' placeholder='". $row['email']."' class='box' />
          <input
            type='number '
            name='phone'
            value='". $row['phone']."'
